...
public class task2 {
    ...
    public static void main(String[] args) {
        String[] emploees = new String[] { "Иван Иванов", "Иван Сидоров", "Сергей Бубнов", "Василий Васильев",
                "Сергей Васильев", "Иван Смирнов", "Павел Петров" };
        ...
        nameRepeat(mapName);
        System.out.println("Имена, отсортированные по убыванию: ");
        sortName(mapName);
    }
}
